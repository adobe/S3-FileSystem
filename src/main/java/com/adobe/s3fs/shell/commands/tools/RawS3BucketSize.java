...
@Command(
    name = "rawS3BucketDu",
    description = "Computes the raw size of an S3 bucket managed by S3FS.",
    groupNames = TOOLS)
public class RawS3BucketSize implements Runnable {
  ...
  public void run() {
    ...
    if (keyCountOny) {
      ...
      System.out.println("Keys: " + content.getObjectCount());
    }
  }
}
