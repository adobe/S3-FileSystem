...
public class CommaSeparatedRestrictionFactory implements OptionRestrictionFactory {
  @Override
  public OptionRestriction createOptionRestriction(Annotation annotation) {
    if (annotation instanceof CommaSeparatedValues) {
      return new None();
    }
  ...
  public List<Class<? extends Annotation>> supportedOptionAnnotations() {
    ...
    supported.add(CommaSeparatedValues.class);
    return supported;
  }
}
